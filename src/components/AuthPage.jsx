  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-24 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="max-w-md w-full backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl p-8 shadow-2xl relative z-10"
      >
        {/* Logo */}
        <div className="text-center mb-8">
          <div className="w-16 h-16 mx-auto bg-gradient-to-br from-purple-500 to-pink-600 rounded-full flex items-center justify-center text-3xl mb-4">
            🎯
          </div>
          <h1 className="text-3xl font-bold text-white mb-2">
            {isLogin ? 'Welcome Back!' : 'Join VocaLens'}
          </h1>
          <p className="text-gray-300">
            {isLogin ? 'Login to continue your journey' : 'Start discovering your career path'}
          </p>
        </div>

        {/* Auth Toggle */}
        <div className="flex gap-2 mb-6 backdrop-blur-sm bg-white/5 rounded-lg p-1">
          <button
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full py-3 bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg"
          >
        ...
        <div className="mt-6">
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-white hover:bg-white/10 transition-all duration-300">
